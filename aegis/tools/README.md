...
python aegis/tools/ncp_query.py

# Get chapter information
python aegis/tools/ncp_query.py --chapter 4

# Get detailed scene requirements
python aegis/tools/ncp_query.py --scene 1.4

# Get character state at specific chapter
python aegis/tools/ncp_query.py --character Lex --chapter 4

# Verbose output with all details
python aegis/tools/ncp_query.py --chapter 4 --verbose

# Find all scenes featuring an alter
python aegis/tools/ncp_query.py --find-alter Kiko
```
...
python aegis/tools/ncp_validate.py manuscript/act_1/chapter_01_scene_01.md

# Specify chapter explicitly
python aegis/tools/ncp_validate.py scene.md --chapter 1

# Verbose output with all issues
python aegis/tools/ncp_validate.py scene.md --verbose

# Specify scene ID for detailed checks
python aegis/tools/ncp_validate.py scene.md --scene 1.1
```
...
**Example Output**:
```bash
$ python aegis/tools/ncp_validate.py chapter_01_scene_01.md --verbose
============================================================
VALIDATION REPORT
============================================================
...
python aegis/tools/ncp_assist.py --scene 1.4 --prompt

# Generate chapter overview prompt
python aegis/tools/ncp_assist.py --chapter 4 --prompt

# Get character voice sample
python aegis/tools/ncp_assist.py --character Lex --voice-sample

# Get character voice at specific chapter
python aegis/tools/ncp_assist.py --character Lex --chapter 4 --voice-sample

# Get style guidance for a chapter
python aegis/tools/ncp_assist.py --chapter 15 --style-guide

# Verbose output with all details
python aegis/tools/ncp_assist.py --scene 1.4 --prompt --verbose
```
...
```bash
# Add an entity
python aegis/tools/kg_add.py --level L1 --type entity --content "Kael" \
  --metadata '{"chapter": 4}' --tags character,protagonist

# Add a fact
python aegis/tools/kg_add.py --level L1 --type fact \
...
```bash
# Query by level
python aegis/tools/kg_query.py --level L1

# Query by chapter
python aegis/tools/kg_query.py --chapter 4

# Search content
python aegis/tools/kg_query.py --search "Kael"

# JSON output
python aegis/tools/kg_query.py --level L1 --json
```
...
python aegis/tools/ncp_assist.py --character Lex --voice-sample
python aegis/tools/ncp_assist.py --character Rhys --voice-sample

# 3. Check detailed scene requirements
python aegis/tools/ncp_query.py --scene 1.4 --verbose > scene_plan.txt

# 4. Write scene (human)
vim manuscript/act_1/chapter_04.md

# 5. Validate
python aegis/tools/ncp_validate.py chapter_04.md --verbose

# 6. Update knowledge graph (future)
python aegis/tools/kg_add.py --source chapter_04.md --auto-extract
...
### NCP File Location
Tools auto-detect NCP file at `aegis/ncp/kohaerenz_protokoll.ncp.json`

Override with `--ncp /path/to/file.json`

### JSON Schema Validation
All tools validate NCP against `aegis/ncp/schema.json` on load
...
python aegis/tools/ncp_assist.py --character Lex --chapter 4 --voice-sample
python aegis/tools/ncp_assist.py --character Kiko --chapter 4 --voice-sample

# Get detailed technical requirements
python aegis/tools/ncp_query.py --scene 1.4 --verbose
...
python aegis/tools/ncp_query.py --find-alter Nyx

# Track Nyx's arc across acts
python aegis/tools/ncp_query.py --character Nyx --chapter 1   # Act I
python aegis/tools/ncp_query.py --character Nyx --chapter 20  # Act II
python aegis/tools/ncp_query.py --character Nyx --chapter 35  # Act III
```
...
# If validation fails:
python aegis/tools/ncp_validate.py chapter_04.md --suggest-fixes

# Revise and re-validate
vim chapter_04.md
python aegis/tools/ncp_validate.py chapter_04.md

# When passed, update knowledge graph
python aegis/tools/kg_add.py --source chapter_04.md
```
