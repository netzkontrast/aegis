...
|---|---|---|
| `AEGIS__Philosophische_und_Systemtheoretische_Analyse_.docx` | Grundlagen: Was ist AEGIS? Definition, Axiome, Systemlogik | ⭐⭐⭐ Kern |
| `AEGIS__Philosophische_Analyse_und_Manifest_.docx` | Ursprungsphilosophie + das AEGIS-Manifest (intern) | ⭐⭐⭐ Kern |
| `Aegis__Logik_in_der_Leere_.docx` | Interne Architektur, autopoietische Grenzen, Logik an der Existenzgrenze | ⭐⭐⭐ Kern |
| `AEGIS_Paradoxon__Neukonzeption_und_Analyse_.docx` | Zentrales Paradoxon von AEGIS — theoretische Fundierung | ⭐⭐ Vertiefung |
| `AEGIS__Singularität_jenseits_Entropiegleichung_.docx` | Expertenrezension: AEGIS als Singularität | ⭐⭐ Vertiefung |
| `AEGIS__Singularität_jenseits_Entropiegleichung_0A.docx` | Erweiterte Version der Singularitäts-Analyse (0A = Überarbeitung) | ⭐ Referenz |
| `Transzendenz_logischer_Systeme__Entropie_0A.docx` | Selbstdefinition von AEGIS: Entropie & Selbstreferenz | ⭐⭐ Vertiefung |
...
| Datei | Inhalt | Priorität |
|---|---|---|
| `Simulation__Realität_und_das_Fundament_0A.docx` | Tiefenbohrung: Simulation vs. Realität — Fundament aller Konzepte | ⭐⭐⭐ Kern |
| `Entropie__Narrative_und_digitale_Welten_.docx` | Entropie als narratives Werkzeug; Landauer-Prinzip in der Prosa | ⭐⭐⭐ Kern |
| `Symmetrie__Paradoxie__Existenz_jenseits_Simulation.docx` | Symmetrien & Paradoxien jenseits der Simulation | ⭐⭐ Vertiefung |
| `Roman-Fundament__Theoretische_Recherche_0A.docx` | Information, Emergenz, Kontrolle — konzeptionelle Grundlagen | ⭐⭐⭐ Kern |
...
| Datei | Inhalt | Priorität |
|---|---|---|
| `Junas_Liebe__Kaels_Trauma__AEGIS_0A.docx` | Juna als Transzendenz-Figur + Kaels Traumatisierung + AEGIS-Interaktion | ⭐⭐⭐ Kern |
| `Roman__Urvertrauen__Liebe__Transzendenz_.docx` | Psychologische Tiefenanalyse: Urvertrauen, Bindung, Liebe | ⭐⭐⭐ Charakter |
| `Roman__Urvertrauen__Liebe__Transzendenz_0A.docx` | Überarbeitete Version (bevorzugen bei Konflikten) | ⭐⭐ Charakter |
...
| Datei | Inhalt | Priorität |
|---|---|---|
| `Trauma-Archäologie__Interdisziplinäre_Konzeptentwicklung_0A.docx` | Interdisziplinäre Konzepte zur existenziellen Verwundung | ⭐⭐⭐ Kern |
...
| Datei | Inhalt | Priorität |
|---|---|---|
| `Roman-Lokalitäten__Konzept_und_Ausarbeitung_0A.docx` | Vollständiges Lokalitäten-Konzept v2.0 — alle Schauplätze | ⭐⭐⭐ Kern |
...
| Datei | Inhalt | Priorität |
|---|---|---|
| `Existenz__Kosmos__Sein_und_Bewusstsein_.docx` | Kosmos, Sein, Bewusstsein — philosophische Grundfragen | ⭐⭐ Theorie |
| `Transzendenz_und_Paradoxien__Verbindungslinien.docx` | Verflechtung von Transzendenz & Paradoxie (interdisziplinär) | ⭐⭐ Theorie |
...
| Datei | Inhalt | Priorität |
|---|---|---|
| `Roman-Konzept__39_Narrative_Kernkonzepte_.docx` | 39 Kernkonzepte als thematischer Fahrplan des Romans | ⭐⭐⭐ Kern |
| `Roman-Outline__Leserlebnis_und_Tiefe_.docx` | Strategisches Entwurfskonzept: Philosophie + Narrativ-Psychologie | ⭐⭐⭐ Kern |
...
| Datei | Inhalt | Priorität |
|---|---|---|
| `Hard_Sci-Fi__Cosmic_Horror-Lektionen_0A.docx` | 15 Lektionen für Hard Sci-Fi / Cosmic Horror Autoren | ⭐⭐⭐ Technik |
| `Narrative_Tiefenrecherche__Subjektivität_und_Resonanz_.docx` | (auch Cluster G) Subjektivität & Resonanz-Forschung | ⭐⭐ Technik |
...
|---|---|
| AEGIS-Manifest | `AEGIS__Philosophische_Analyse_und_Manifest_.docx` |
| Alters (Manager, Nox, Kind) | `Junas_Liebe__Kaels_Trauma__AEGIS_0A.docx` + `Prinzipien.docx` |
| Dual-Kernel-Theorie (DKT) | `Simulation__Realität_und_das_Fundament_0A.docx` |
| Entropie / Landauer-Prinzip | `Entropie__Narrative_und_digitale_Welten_.docx` |
| Gödel / Unvollständigkeit | `AEGIS_Paradoxon__Neukonzeption_und_Analyse_.docx` |
| Holografisches Trauma | `Trauma-Archäologie__Interdisziplinäre_Konzeptentwicklung_0A.docx` |
| Juna | `Junas_Liebe__Kaels_Trauma__AEGIS_0A.docx` |
| K₀ / K₁ Kernel | `Roman-Fundament__Theoretische_Recherche_0A.docx` |
| Kapitel-Subplots | `AEGIS-Subplots__Kapitelweise_System-Exploration_0A.docx` |
| Konstrukt-Stadt (Setting) | `Roman-Lokalitäten__Konzept_und_Ausarbeitung_0A.docx` |
| LogOS | `Aegis__Logik_in_der_Leere_.docx` |
| Meta-Twist / Leser als Beobachter | `Roman-Worldbuilding__Fragmentierte_Identität___Meta-Realität_0A.docx` |
| Schauplätze | `Roman-Schauplätze__Detaillierte_Outline-Ausarbeitung_.docx` |
| Simulation | `Simulation__Realität_und_das_Fundament_0A.docx` |
| Stasis-Lücken (Foreshadowing) | `Roman-Outline__Leserlebnis_und_Tiefe_.docx` |
